...
const Compare = ({ firstPayload, secondPayload }: { firstPayload: PXPayload; secondPayload: PXPayload }) => {
  return (
    <div className='p-3'>
      <Row className='align-items-center justify-content-center w-100 mb-5 rounded'>
        <Col className='col-6 h-100 light d-flex flex-column rounded'>
      ...
      <h2 className='my-3'>Step Differences</h2>
